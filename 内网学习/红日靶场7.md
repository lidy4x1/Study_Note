...
run get_local_subnets
 ![在这里插入图片描述](image/ae69e7aa92a7404291c7c5bd495a3c8a.png)
 run autoroute -p
 ![在这里插入图片描述](image/060ef7d65ace4254962a706ee8d8cdd1.png)
 run post/multi/manage/autoroute
 ![在这里插入图片描述](image/eb888da9e2034c9f96400a2b381c6ad1.png)
 ![在这里插入图片描述](image/watermark,type_d3F5LXplbmhlaQ,shadow_50,text_Q1NETiBARmF0ZXNlYw==,size_20,color_FFFFFF,t_70,g_se,x_16.png)